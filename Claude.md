...
**Endpoints:**
- `https://<your-modal-workspace>--list-webhooks.modal.run` - List webhooks
- `https://<your-modal-workspace>--directive.modal.run?slug={slug}` - Execute directive
- `https://<your-modal-workspace>--test-email.modal.run` - Test email
